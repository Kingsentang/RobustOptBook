...
$$
\begin{align}
\max &\quad\pmb{c^\prime} \pmb{x} + \mathop {\max }\limits_{\\\{ {\left. {{S_0}} \right|{S_0} \subseteq {J_0},\left| S\_0 \right| \leq \Gamma\_0} \\\}} \\\{ {\sum\limits\_{j \in {S_0}} {d\_j\left| x\_j \right|} } \\\} \label{Bertsimas and Sim counterpart}\\\\\\ 
\text {s.t.} &\sum\limits_{j} a\_{i j}x\_j+\mathop {\max }\limits_{\\\{ {\left. {S\_i \cup \\\{ t\_i \\\}} \right|S\_i \subseteq J\_i,\left| S\_i \right| = \left\lfloor \Gamma\_i \right\rfloor ,t\_i \in J\_i\backslash S_\i} \\\}} 
