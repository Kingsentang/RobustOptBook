...
$$
\begin{align}
\max &\quad\pmb{c^\prime} \pmb{x} + \mathop {\max }\limits_{\\\{ {\left. {{S_0}} \right|{S_0} \subseteq {J_0},\left| {{S_0}} \right| \leqslant {\Gamma_0}} \\\}} \\\{ {\sum\limits\_{j \in {S_0}} {{{\pmb{d}}\_j}\left| {{{x}\_j}} \right|} } \\\}\\\\\\ 
...
$$
\begin{align}
\max &\quad\pmb{c^\prime} \pmb{x}+\pmb{z}_{0} \Gamma_{0}+\sum_{j \in J_{0}} \pmb{p}\_{0j} \\\\\\
