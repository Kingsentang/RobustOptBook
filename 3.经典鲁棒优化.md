...
\begin{align}
\max &\quad\pmb{c^\prime} \pmb{x}\\\\\\ 
\text {s.t.} &\sum\_{j} a\_{ij} x\_{j} + \underset{\\\{ S\_{i} \cup \\\{ t\_{i} \\\} \mid S\_{i}} \subseteq J\_{i}, \left| S\_{i} \right| = \left\lfloor \Gamma\_{i} \right\rfloor, t\_{i}\in J\_{i} \backslash S\_{i} \\\} {\mathop{\max}}\,
\\\{ \sum\limits\_{j\in S\_{i}}{\hat{a}\_{ij}{y\_j}+\left( \Gamma\_i-\left\lfloor \Gamma\_i \right\rfloor  \right)a\_{it\_i}y\_{t\_{i}} \\\}\leq b\_{i}&&\forall i \\\\\\ 
&\pmb{1} \leq \pmb{x} \leq \pmb{u} \\\\\\ 
...
\\\{ \sum\limits\_{j\in S\_{i}}{\hat{a}\_{ij}{y\_j} \\\}\leq b\_{i}
$$
