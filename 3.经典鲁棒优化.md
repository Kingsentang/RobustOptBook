...
$$
\underset{\\\{ \left. S\_{i}\cup \\\{ t\_{i} \\\} \right|S\_{i}\subseteq J\_{i},\left| S\_{i} \right|=\left\lfloor \Gamma\_{i} \right\rfloor ,t\_{i}\in J\_{i}\backslash S\_{i} \\\}}{\mathop{\max }}\,\\\{ \sum\limits\_{j\in S\_{i}}{\hat{\pmb{a}}\_{i j}y\_{j}+\left( {{\Gamma}\_{i}}-\left\lfloor {{\Gamma }\_{i}} \right\rfloor  \right)a\_{i{t\_{i}}}y\_{t\_{i}}} \\\}
$$
等价为以下的线性优化模型：
$$
\begin{align} 
