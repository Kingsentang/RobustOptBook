...
\text {s.t.} &\quad\sum\_{j} \pmb{a}\_{i j} x\_{j}+\sum_{j \in J} \tilde{\pmb{a}}\_{i j} \pmb{y}\_{j}+\Omega\_{i} \sqrt{\sum\_{j \in J}\left(\hat{\pmb{a}}\_{i j}^{2} x\_{j}^{2}\right)} \leq \pmb{b}\_{i} && \forall i \\\\\\
...
\begin{align}
\max &\quad\pmb{c^\prime} \pmb{x}\\\\\\ 
\text {s.t.} &\sum\_{j}{{{\pmb{a}}\_{i j}}{{x}\_{j}}} + \underset{\\\{ \left. {{S}\_{i}}\cup \\\{ {{t}\_{i}} \\\} \right|{{S}\_{i}}\subseteq {{J}\_{i}},\left| {{S}\_{i}} \right|=\left\lfloor {{\Gamma }\_{i}} \right\rfloor ,{{t}\_{i}}\in {{J}\_{i}}\backslash {{S}\_{i}} \\\}}{\mathop{\max }}\,\\\{ \sum\limits\_{j\in {{S}\_{i}}}{\hat{\pmb{a}}\_{i j}{{\pmb{y}}\_{j}}+\left( {{\Gamma }\_{i}}-\left\lfloor {{\Gamma }\_{i}} \right\rfloor  \right){{\pmb{a}}\_{i{{t}\_{i}}}}{{\pmb{y}}\_{{{t}\_{i}}}}} \\\}\leq {{\pmb{b}}\_{i}}&&\forall i \\\\\\ 
&{\pmb{1} \leq \pmb{x} \leq \pmb{u}} \\\\\\ 
&{-\pmb{y}\_{j} \leq x\_{j} \leq \pmb{y}\_{j}} && \forall j \\\\\\ 
&{\pmb{y} \geq 0}
\end{align}
...
$$
\sum\limits_{j}{{{\pmb{a}}\_{i j}}{{x}\_{j}}}+\underset{\\\{ \left. {{S}\_{i}}\cup \\\{ {{t}\_{i}} \\\} \right|{{S}\_{i}}\subseteq {{J}\_{i}},\left| {{S}\_{i}} \right|=\left\lfloor {{\Gamma}\_{i}} \right\rfloor, {{t}\_{i}}\in {{J}\_{i}}\backslash {{S}\_{i}} \\\}}{\mathop{\max }}\,\\\{ \sum\limits\_{j\in {{S}\_{i}}}{\hat{\pmb{a}}\_{i j}{{\pmb{y}}\_{j}}} \\\}\le {\pmb{b}}\_{i}
$$
...
\begin{align}
\max &\quad\pmb{c^\prime} \pmb{x} \\\\\\
\text {s.t.} &\sum\_{j} \pmb{a}\_{i j} x\_{j}+\pmb{z}\_{i} \Gamma\_{i}+\sum\_{j \in J_{i}} \pmb{p}\_{i j} \leq \pmb{b}\_{i} && \forall i \\\\\\ 
&{\pmb{z}\_{i}+\pmb{p}\_{i j} \geq \hat{\pmb{a}}\_{i j} \pmb{y}\_{j}} && \forall i, j \in J\_{i} \\\\\\ 
&{\pmb{1} \leq \pmb{x} \leq \pmb{u}}\\\\\\
&{-\pmb{y}\_{j} \leq x\_{j} \leq \pmb{y}\_{j}} && \forall j \\\\\\
&{\pmb{y} \geq 0} \\\\\\ 
&{\pmb{p}\_{i j} \geq 0} && \forall i, j \in J\_{i} \\\\\\
