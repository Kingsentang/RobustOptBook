...
$$
\sup_{\mathbb{P} \in \mathcal{F}} \mathbb{E}\_{\mathbb{P}}{\pmb{a}^\prime_m(\s,\tilde{\pmb z})\pmb{w} + \pmb{b}^\prime_m(\s,\tilde{\pmb z})\pmb{x}(\s) + \pmb{c}^\prime\_m(\s)\pmb{y}(\s,\tilde{\pmb z}) + d_m(\s,\tilde{\pmb z})} \leq 0 \forall m \in \mathcal{M}\_2.
$$
...
& \displaystyle \sup\_{\mathbb{P} \in \mathcal{F}} \mathbb{E}\_{\mathbb{P}}{\pmb{a}^\prime_m(\s,\tilde{\pmb z})\pmb{w} + \pmb{b}^\prime_m(\s,\tilde{\pmb z})\pmb{x}(\s) + \pmb{c}^\prime_m(\s)\pmb{y}(\s,\tilde{\pmb z}) + d_m(\s,\tilde{\pmb z})} \leq 0 & \forall m \in \mathcal{M}\_2 \\\\\\
